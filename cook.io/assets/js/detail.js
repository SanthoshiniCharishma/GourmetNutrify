        ...
        <div class="title-wrapper">
            ...
            <button class="btn btn-secondary has-state has-icon ${isSaved? "saved":"removed"}" onClick="saveRecipe(this,'${recipeId}')">
                ...
                <span class="material-symbols-outlined bookmark"
                 ...
                 <span class="label-large save-text">
                    Save
                 </span>
                 <span class="label-large unsaved-text">
                    Unsave
                 </span>
